...
if( dim(variants)[1]==0 ){
    if( opt$verbose ){  cat( paste0( "MESSAGE: VCF for sample ", opt$sample_id, " harbors no candidates, ending run.\n" ) ) }
...
if( opt$verbose ){ cat( paste0( "MESSAGE: AARDVARK runs completed.\n") )}
